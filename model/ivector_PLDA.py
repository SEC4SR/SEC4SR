...
class ivector_PLDA(nn.Module):

    def __init__(self, model_file, fgmm_file="./iv_system/final_ubm.txt", 
                iv_extractor_file="./iv_system/final_ie.txt",
                plda_file="./iv_system/plda.txt", ivector_meanfile="./iv_system/mean.vec", 
                transform_mat_file="./iv_system/transform.txt", device="cpu",
        ...
        self.helper = ivector_PLDA_helper(fgmm_file, iv_extractor_file, plda_file, 
